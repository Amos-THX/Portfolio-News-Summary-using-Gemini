...
In this example, we are retrieving the relevant market headlines on 26th May 2026. We are able to generate a list of headlines from the markets which helps clients get up to speed quickly on the latest world news.
